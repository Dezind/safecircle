...
// Render only the results section
    include 'results-section.php'; // Ensure this file contains only the results section markup
    exit;
}
...
<script>
    function setFilter(key, value) {
        // Get the current URL and update the parameter
        ...
        fetch(url, { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
            ...
            .then(html => {
                ...
                const resultsSection = document.querySelector('.gallery-container.clearfix');
                const newResults = temp.querySelector('.gallery-container.clearfix');
                if (resultsSection && newResults) {
...
<div class="containerx">
    ...
    $preferencesql = "SELECT *, event_id FROM event_preference_view WHERE user_id = '" . $_SESSION['user_id'] . "' AND event_date >= CURRENT_DATE()";
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.gallery-card').forEach(function(card) {
            card.addEventListener('click', function(e) {
                ...
                if (e.target.classList.contains('share-btn') || e.target.classList.contains('download-btn')) {
                    return;
                }
                ...
                // Redirect to event details page - updated filename here
                if (eventId) {
        ...
        document.querySelectorAll('.gallery-card button').forEach(function(button) {
